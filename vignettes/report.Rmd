...
**1.Square Loss (Regression): **$L(w) = ||Xw-y||^2_2$

**2.Logistic Loss (Binary classification): **$L(w) = \sum^{n}_{i=1}log[1+exp(-\hat{y_i}w^tx)]$
...
In this data set, both Early Stopping and L2 gain a good accuracy
...
Comment on difference in accuracy:
In this data set, the accuracy of Early Stopping and L2 is not clear
...
Comment on difference in accuracy:
In this data set, both Early Stopping and L2 are extremely accurate due to the large number of datas
...
Comment on difference in accuracy:
In this data set, Early Stopping and L2 are both accurate
